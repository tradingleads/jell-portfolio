    ...
    <AnimatePresence>
      {menuOpen && (
        ...
        >
          ...
          <div style={{ width: "100%", maxWidth: 400, padding: "72px 24px 0", display: "flex", flexDirection: "column" }}>
...
function HeroSection() {
  return (
    <section id="hero" className="min-h-[clamp(600px,100dvh,900px)] pb-[40px]" style={{ display: "flex", alignItems: "center", position: "relative", overflow: "hidden", paddingTop: 68, contain: "layout", background: "var(--ld-bg)" }}>
      {/* Hero dot grid */}
...
function SocialProofSection() {
  return (
    <section id="social-proof" className="pt-[20px] pb-[clamp(20px,4vw,32px)]" style={{ paddingLeft: 28, paddingRight: 28, background: "var(--ld-bg)" }}>
...
function TrustBar() {
  return (
    <section id="trust-bar" className="pt-[clamp(32px,8vw,56px)] pb-[clamp(32px,8vw,56px)]" style={{ paddingLeft: 28, paddingRight: 28, background: "var(--ld-bg)" }}>
...
function ProjectsSection() {
  ...
  return (
    <section id="projects" className="pt-[clamp(28px,6vw,36px)] pb-[clamp(20px,4vw,32px)]" style={{ paddingLeft: 20, paddingRight: 20, background: "var(--ld-bg)", scrollMarginTop: 50 }}>
...
function HowIWorkSection() {
  ...
  return (
    <section id="process" className="pt-[clamp(28px,4vw,48px)] pb-[clamp(100px,16vw,180px)]" style={{ paddingLeft: 28, paddingRight: 28, background: "var(--ld-bg)", position: "relative", overflow: "hidden", scrollMarginTop: 50 }}>
      {/* Background glow */}
...
function AboutSection() {
  ...
  return (
    <section id="about" className="pt-[clamp(36px,8vw,60px)] pb-[clamp(36px,8vw,60px)]" style={{ paddingLeft: 28, paddingRight: 28, background: "var(--ld-bg)", scrollMarginTop: 50 }}>
...
function CTASection() {
  return (
    <section id="book-a-call" className="pt-[clamp(28px,4vw,48px)] pb-[clamp(28px,4vw,48px)]" style={{ paddingLeft: 28, paddingRight: 28, background: "var(--ld-card2)", position: "relative", overflow: "hidden", scrollMarginTop: 50 }}>
...
function ContactSection() {
  ...
  return (
    <section id="contact" className="pt-[clamp(48px,9vw,96px)] pb-[clamp(48px,9vw,96px)]" style={{ paddingLeft: 28, paddingRight: 28, background: "var(--ld-card2)", position: "relative", overflow: "hidden", scrollMarginTop: 50 }}>
      <div className="ld-ambient-glow" style={{ position: "absolute", top: 0, left: "50%", transform: "translateX(-50%)", width: 600, height: 320, background: "radial-gradient(ellipse, var(--ld-glow) 0%, transparent 70%)", opacity: 0.4, pointerEvents: "none" }} />
...
function PortfolioSection() {
  ...
  return (
    <section id="portfolio" className="pt-[clamp(40px,8vw,80px)] pb-[clamp(40px,8vw,80px)]" style={{ background: "#05070B", position: "relative", overflow: "hidden" }}>
      <MouseGradient />
