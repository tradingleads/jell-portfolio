...
function HowIWorkSection() {
  ...
  return (
    <section id="process" style={{ minHeight: "calc(100dvh - 50px)", padding: "72px 28px", background: "var(--ld-card2)", position: "relative", overflow: "hidden", scrollMarginTop: 50, display: "flex", flexDirection: "column", justifyContent: "center" }}>
