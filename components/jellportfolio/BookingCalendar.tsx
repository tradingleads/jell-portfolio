...
import { BOOKING_CONFIG, CUSTOM_QUESTIONS, LOCATIONS } from "@/lib/jellportfolio/bookingConfig";
...
export default function BookingCalendar() {
  ...
  useEffect(() => {
    ...
    fetch(`/api/jellportfolio/availability?start=${encodeURIComponent(rangeStart.toISOString())}&end=${encodeURIComponent(rangeEnd.toISOString())}`, { signal: controller.signal })
      .then(r => r.json())
      .then(data => {
